...
public class LocationAlertIntentService extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER ||
            ...
            //Start transition detection activity upon geofence trigger
            Intent tranIntent = new Intent(getBaseContext(),
                    TransitionDetectionActivity.class);
            getApplication().startActivity(tranIntent);
